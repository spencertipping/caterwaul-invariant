...
// | view <-> RPC  ...  RPC 1 <-> filter 1 -               <- this is one client
//                                          \
//   view <-> RPC  ...  RPC 2 <-> filter 2 - database      <- this is another
//                                          /
//   view <-> RPC  ...  RPC 3 <-> filter 3 -               <- and a third
...
// |      RPC      ...  RPC ------
//       /                        \
//   view <-> RPC  ...  RPC 1 <-> filter 1 <-> database
